...
## The Basic Live Support (BLS) Survey
...
|        **Circulation**        | **Check carotid pulse** for 5 to 10 seconds.<br><ul><li>If absent, <strong>start HQCPR (30:2)</strong> starting with chest compressions.</li><li>If a pulse is present, <strong>start rescue breathing q5s/q6s</strong> (10-12/min) and check pulse q2min</li></ul> |
