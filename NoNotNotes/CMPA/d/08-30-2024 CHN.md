...
1. **Census**: either **de jure** (actual residence), or **de facto** (based on where the individual is currently situated) performed by the National Government. It is the most expensive form of data collection in terms of both money and time (done every 5 years).
