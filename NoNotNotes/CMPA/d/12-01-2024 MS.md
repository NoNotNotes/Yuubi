A client with cancer is being evaluated for possible metastasis. Which of the following are the most common metastasis sites for cancer cells? Select all that apply.
1. Colon
...
The nurse is performing an admission assessment on a client who has been diagnosed with diabetes insipidus. Which of the following drugs should the nurse expect to administer as ordered? Select all that apply.
1. Ethacrynic Acid
2. Diabenase
3. Glipzide
4. Declomycin
...
A client with retroperitoneal abscess is receiving gentamycin (Garamycin). Which o the following should the nurse monitor? Select all that apply.
1. Hearing
2. Urine output
3. Hematocrit
...
Which of the following patients are at risk for developing heart failure? Select all that apply. 
